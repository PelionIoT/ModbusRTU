...
SerialCommInterface.prototype.start = function() {
	...
	var onData = _.debounce(function () {
        ...
        self.buffers = [];
    }, self._endPacketTimeout);


	return new Promise(function(resolve, reject) {
		logger.info('Trying opening the port '+ self._siodev + ' with baudrate '+ self._baudrate);
		...
		self._serialPort.open(function(err) {
			...
			logger.info('Connection with zwave controller established successful on port '+ self._siodev);
